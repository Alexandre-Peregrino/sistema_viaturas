...
@section('content')
<div class="container">
  <h3 class="mb-4"><i class="bi bi-graph-up-arrow"></i> RotaWeb • Efetivo Executado</h3>
  ...
  <div class="card">
    <div class="card-body">
      <form method="GET" action="{{ route('admin.relatorios.rotaweb.efetivo_executado.resultado') }}" class="row g-3">
        <div class="col-md-4">
