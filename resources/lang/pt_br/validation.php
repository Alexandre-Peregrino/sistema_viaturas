...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Estas são as mensagens padrão de validação do Laravel.
    | Você pode personalizar para tornar mais amigável em Português.
    |
    */
    ...
    */
    ...
    'custom' => [
        ...
        'placa' => [
            'unique' => 'Já existe uma viatura cadastrada com esta placa.',
            'regex'  => 'O formato da placa deve ser AAA-1234 ou AAA1A23.',
        ],
    ],
